      ...
      <section className="mx-auto w-full max-w-6xl pt-6">
        <div className="mb-6">
          ...
          <p className="mt-3 max-w-xl text-base font-semibold text-[#6f5a26]">
            Выберите улей, чтобы отметить необходимость откачки или лечения.
          </p>
        </div>

        <BgHome
          component={hives}
          onOpenDetails={handleOpenChecks}
          showDelete={false}
        />
      </section>
...
export default ChecksPerformed
